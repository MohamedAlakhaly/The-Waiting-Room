...
export function HeroSection() {
  ...
  const countries = [
    t("countries.palestine"),
    t("countries.yemen"),
    t("countries.syria"),
    t("countries.afghanistan"),
    t("countries.sudan"),
    t("countries.kurdistan"),
    t("countries.eritrea"),
    t("countries.somalia")
  ];
          ...
          >
                ...
                <div className="flex -space-x-3">
                  {[
                    ...
                    <motion.div
                      ...
                      className={`h-12 w-12 rounded-full border-2 border-background flex items-center justify-center ${color}`}
                    >
                  ...
                  <motion.div
                    ...
                    className="h-12 w-12 rounded-full border-2 border-background bg-primary/20 text-primary flex items-center justify-center text-xs font-bold"
                  >
                    +1k
                  </motion.div>
                </div>
            ...
            >
              <p className="text-2xl font-bold text-primary">
                <AnimatedNumber value={usersCount} suffix="+" />
              </p>
