        ...
        <div className="overflow-hidden rounded-2xl bg-secondary p-8 text-secondary-foreground sm:p-12">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-col gap-4">
              <span className="text-xs font-semibold uppercase tracking-wider text-secondary-foreground/70">
                Real-Time Impact Tracker
              </span>
              
              <div className="flex items-baseline gap-4">
                <span className="font-serif text-5xl font-bold sm:text-6xl lg:text-7xl">
              ...
              <div className="max-w-md">
                <div className="h-3 overflow-hidden rounded-full bg-secondary-foreground/20">
                  <div 
